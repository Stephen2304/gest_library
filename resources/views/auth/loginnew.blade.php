          ...
          <div class="card bg-secondary border-0 mb-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <div class="text-center text-danger mb-4">
                <small><x-auth-session-status class="mb-4" :status="session('status')" /></small>

                <!-- Validation Errors -->
                <small><x-auth-validation-errors class="mb-4" :errors="$errors" /></small>
              </div>
